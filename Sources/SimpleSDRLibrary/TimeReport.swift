...
public class TimeReport {
    ...
    public func printAccumulated(reset:Bool=false) {
        ...
        print("TimeReport",name,
              "average",formatter.string(from:NSNumber(value:average.rounded()))!,
              "nSec. max",formatter.string(for:maximum)!,
              "min",formatter.string(for:minimum)!,
              "count",formatter.string(for:count)!,
              "high",formatter.string(for:highCount)!,
              "bad",formatter.string(for:badCount)!)
        if reset { self.reset() }
    }

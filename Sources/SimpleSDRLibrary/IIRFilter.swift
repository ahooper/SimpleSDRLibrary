...
public class IIRFilter<Samples:DSPSamples>:BufferedStage<Samples,Samples> {
    ...
    init<S:SourceProtocol>(source:S?, _ forwardCoefficients:[Float], _ backwardCoefficients:[Float])
                    where S.Output == Samples {
        ...
        super.init("IIRFilter", source:source)
    }
...
public class IIR22Filter<Samples:DSPSamples>:BufferedStage<Samples,Samples> {
    ...
    init<S:SourceProtocol>(source:S?, _ forwardCoefficients:[Float], _ backwardCoefficients:[Float])
        ...
        super.init("IIR22Filter", source:source)
    }
